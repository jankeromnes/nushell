...
impl TokenTreeBuilder {
    ...
    fn consume_delimiter(
        ...
        let open = Tag::from((start_open_paren, end_open_paren));
        let close = Tag::from((start_close_paren, end_close_paren));
        let whole = Tag::from((start_open_paren, end_close_paren));
